...
import { MenuInlineItems } from './menu-inline-items';

export interface IMenuInlineProps {
  dimensionsConfig: IDimensions;
  currentName: string;
  onRefresh(): void;
}

export function MenuInline(props: IMenuInlineProps) {
    ...
    <>
      ...
      <div className="MenuInline">
        <MenuInlineItems
          ...
          onRefresh={onRefresh}
        />
        <MenuInlineItems items={MENU_SIDE_DESKTOP_ITEMS_BOTTOM} />
      </div>
    </>
  );
}
